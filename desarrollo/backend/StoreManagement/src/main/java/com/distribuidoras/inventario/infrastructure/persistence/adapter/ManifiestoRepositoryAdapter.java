...
public class ManifiestoRepositoryAdapter implements ManifiestoRepository {
    ...
    @Override public Optional<Manifiesto> findById(UUID id) { return jpa.findById(id).map(this::toDomain); }
    ...
    @Override public Manifiesto save(Manifiesto m) { return toDomain(jpa.save(toEntity(m))); }
