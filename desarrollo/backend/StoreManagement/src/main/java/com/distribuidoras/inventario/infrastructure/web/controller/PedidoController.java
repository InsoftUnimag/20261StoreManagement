...
public class PedidoController {
    ...
    public ResponseEntity<Map<String, Object>> crearPedido(
        ...
        PedidoCommand command = new PedidoCommand(
                ...
                request.lineas().stream()
                        .map(linea -> new LineaCommand(linea.skuId(), linea.cantidadSolicitada()))
                        .toList()
        );
    ...
    public ResponseEntity<PedidosListResponseDTO> listarPedidos(
        ...
        FiltrosDTO filtros = new FiltrosDTO(
                estado != null ? com.distribuidoras.inventario.domain.model.enums.EstadoPedido.valueOf(estado) : null,
                clienteCc,
                numeroPedido,
                fechaDesde,
                fechaHasta,
