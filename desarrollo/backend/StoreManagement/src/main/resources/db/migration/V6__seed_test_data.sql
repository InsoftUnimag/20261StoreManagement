...
-- ══════════════════════════════════════════════════════════════
-- 3. RECEPCIONES (vinculadas a manifiestos)
-- ══════════════════════════════════════════════════════════════
INSERT INTO recepcion (recepcion_id, manifiesto_id, operario_id, fecha_recepcion, numero_recepcion, notas) VALUES
('e1000000-0000-0000-0000-000000000001','a1000000-0000-0000-0000-000000000001','81000000-0000-0000-0000-000000000010',NOW()-INTERVAL'5 days','REC-001','Recepcion total MAN-2026-001'),
('e1000000-0000-0000-0000-000000000002','a1000000-0000-0000-0000-000000000002','81000000-0000-0000-0000-000000000011',NOW()-INTERVAL'10 days','REC-002','Recepcion parcial MAN-2026-002'),
('e1000000-0000-0000-0000-000000000003','a1000000-0000-0000-0000-000000000003','81000000-0000-0000-0000-000000000012',NOW()-INTERVAL'15 days','REC-003','Recepcion total MAN-2026-003'),
('e1000000-0000-0000-0000-000000000004','a1000000-0000-0000-0000-000000000004','81000000-0000-0000-0000-000000000013',NOW()-INTERVAL'20 days','REC-004','Recepcion total MAN-2026-004'),
('e1000000-0000-0000-0000-000000000005','a1000000-0000-0000-0000-000000000005','81000000-0000-0000-0000-000000000014',NOW()-INTERVAL'25 days','REC-005','Recepcion total MAN-2026-005')
ON CONFLICT (recepcion_id) DO NOTHING;

-- ══════════════════════════════════════════════════════════════
-- 4. LOTES (con recepcion_id)
-- ══════════════════════════════════════════════════════════════
...
('LOT-001-A','SKU-001',120,CURRENT_DATE+15,'2026-01-15',true,true,1.50,'e1000000-0000-0000-0000-000000000002',NOW()),
('LOT-001-B','SKU-001',80,CURRENT_DATE+180,'2026-03-01',true,false,1.55,'e1000000-0000-0000-0000-000000000002',NOW()),
('LOT-002-A','SKU-002',200,CURRENT_DATE+60,'2026-02-01',true,false,1.20,'e1000000-0000-0000-0000-000000000002',NOW()),
('LOT-002-B','SKU-002',150,CURRENT_DATE+300,'2026-08-01',true,false,1.25,'e1000000-0000-0000-0000-000000000002',NOW()),
('LOT-003-A','SKU-003',100,CURRENT_DATE+45,'2026-01-10',true,false,1.45,'e1000000-0000-0000-0000-000000000002',NOW()),
('LOT-003-B','SKU-003',90,CURRENT_DATE+200,'2026-06-01',true,false,1.50,'e1000000-0000-0000-0000-000000000002',NOW()),
('LOT-004-A','SKU-004',180,CURRENT_DATE+90,'2026-03-01',true,false,1.15,'e1000000-0000-0000-0000-000000000002',NOW()),
('LOT-004-B','SKU-004',120,CURRENT_DATE+250,'2026-08-15',true,false,1.20,'e1000000-0000-0000-0000-000000000002',NOW()),
('LOT-005-A','SKU-005',95,CURRENT_DATE+7,'2026-01-25',true,true,1.40,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-005-B','SKU-005',85,CURRENT_DATE+150,'2026-05-10',true,false,1.42,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-006-A','SKU-006',220,CURRENT_DATE+80,'2026-02-05',true,false,1.10,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-006-B','SKU-006',160,CURRENT_DATE+365,'2026-12-01',true,false,1.12,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-007-A','SKU-007',110,CURRENT_DATE+20,'2026-02-20',true,true,1.38,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-007-B','SKU-007',70,CURRENT_DATE+120,'2026-04-15',true,false,1.40,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-008-A','SKU-008',190,CURRENT_DATE+100,'2026-03-10',true,false,1.18,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-008-B','SKU-008',130,CURRENT_DATE+280,'2026-09-28',true,false,1.22,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-009-A','SKU-009',60,CURRENT_DATE+180,'2026-04-01',true,false,2.50,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-009-B','SKU-009',45,CURRENT_DATE+450,'2027-01-15',true,false,2.60,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-010-A','SKU-010',140,CURRENT_DATE+70,'2026-02-15',true,false,1.30,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-010-B','SKU-010',100,CURRENT_DATE+210,'2026-07-20',true,false,1.35,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-011-A','SKU-011',80,CURRENT_DATE+240,'2026-07-01',true,false,4.50,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-011-B','SKU-011',50,CURRENT_DATE+480,'2027-04-15',true,false,4.80,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-012-A','SKU-012',95,CURRENT_DATE+200,'2026-06-20',true,false,3.80,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-012-B','SKU-012',70,CURRENT_DATE+400,'2027-01-10',true,false,4.00,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-013-A','SKU-013',110,CURRENT_DATE+10,'2026-01-30',true,true,2.20,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-013-B','SKU-013',75,CURRENT_DATE+160,'2026-06-25',true,false,2.30,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-014-A','SKU-014',125,CURRENT_DATE+130,'2026-04-15',true,false,2.25,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-014-B','SKU-014',90,CURRENT_DATE+320,'2026-11-20',true,false,2.35,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-015-A','SKU-015',50,CURRENT_DATE+220,'2026-07-30',true,false,3.50,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-015-B','SKU-015',35,CURRENT_DATE+440,'2027-02-01',true,false,3.70,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-016-A','SKU-016',200,CURRENT_DATE+5,'2026-01-20',true,true,1.25,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-016-B','SKU-016',150,CURRENT_DATE+170,'2026-06-10',true,false,1.30,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-017-A','SKU-017',45,CURRENT_DATE+145,'2026-05-25',true,false,3.20,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-017-B','SKU-017',30,CURRENT_DATE+330,'2026-11-20',true,false,3.40,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-018-A','SKU-018',55,CURRENT_DATE+18,'2026-02-15',true,true,3.80,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-018-B','SKU-018',40,CURRENT_DATE+195,'2026-08-20',true,false,4.00,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-019-A','SKU-019',180,CURRENT_DATE+175,'2026-06-25',true,false,1.80,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-019-B','SKU-019',120,CURRENT_DATE+380,'2027-01-10',true,false,1.90,'e1000000-0000-0000-0000-000000000003',NOW()),
('LOT-020-A','SKU-020',150,CURRENT_DATE+230,'2026-07-15',true,false,2.00,'e1000000-0000-0000-0000-000000000001',NOW()),
('LOT-020-B','SKU-020',100,CURRENT_DATE+410,'2027-02-25',true,false,2.10,'e1000000-0000-0000-0000-000000000001',NOW()),
('LOT-021-A','SKU-021',80,CURRENT_DATE+270,'2026-08-05',true,false,2.80,'e1000000-0000-0000-0000-000000000001',NOW()),
('LOT-021-B','SKU-021',60,CURRENT_DATE+470,'2027-04-15',true,false,2.90,'e1000000-0000-0000-0000-000000000001',NOW()),
('LOT-022-A','SKU-022',70,CURRENT_DATE+290,'2026-09-10',true,false,3.50,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-022-B','SKU-022',45,CURRENT_DATE+490,'2027-05-01',true,false,3.70,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-023-A','SKU-023',65,CURRENT_DATE+260,'2026-08-25',true,false,3.60,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-023-B','SKU-023',50,CURRENT_DATE+400,'2027-01-20',true,false,3.80,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-024-A','SKU-024',130,CURRENT_DATE+115,'2026-03-30',true,false,2.40,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-024-B','SKU-024',90,CURRENT_DATE+285,'2026-10-10',true,false,2.50,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-025-A','SKU-025',110,CURRENT_DATE+200,'2026-07-20',true,false,2.60,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-026-A','SKU-026',75,CURRENT_DATE+250,'2026-08-10',true,false,2.95,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-027-A','SKU-027',140,CURRENT_DATE+190,'2026-07-05',true,false,2.15,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-028-A','SKU-028',160,CURRENT_DATE+160,'2026-06-15',true,false,2.20,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-029-A','SKU-029',50,CURRENT_DATE+340,'2026-12-10',true,false,5.20,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-030-A','SKU-030',40,CURRENT_DATE+365,'2027-01-01',true,false,6.50,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-031-A','SKU-031',35,CURRENT_DATE+350,'2026-12-20',true,false,7.00,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-032-A','SKU-032',30,CURRENT_DATE+380,'2027-02-15',true,false,8.50,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-033-A','SKU-033',38,CURRENT_DATE+370,'2027-01-30',true,false,8.00,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-034-A','SKU-034',55,CURRENT_DATE+290,'2026-10-20',true,false,4.50,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-035-A','SKU-035',60,CURRENT_DATE+300,'2026-11-05',true,false,4.45,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-036-A','SKU-036',25,CURRENT_DATE+360,'2027-01-15',true,false,5.80,'e1000000-0000-0000-0000-000000000004',NOW()),
('LOT-037-A','SKU-037',100,CURRENT_DATE+210,'2026-07-25',true,false,1.75,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-038-A','SKU-038',120,CURRENT_DATE+200,'2026-07-15',true,false,1.80,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-039-A','SKU-039',115,CURRENT_DATE+195,'2026-07-10',true,false,1.78,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-040-A','SKU-040',125,CURRENT_DATE+205,'2026-07-20',true,false,1.82,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-041-A','SKU-041',180,CURRENT_DATE+140,'2026-05-15',true,false,1.65,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-042-A','SKU-042',70,CURRENT_DATE+270,'2026-09-05',true,false,3.30,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-043-A','SKU-043',75,CURRENT_DATE+280,'2026-09-20',true,false,3.25,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-044-A','SKU-044',60,CURRENT_DATE+250,'2026-08-25',true,false,3.80,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-045-A','SKU-045',65,CURRENT_DATE+260,'2026-09-05',true,false,3.75,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-046-A','SKU-046',90,CURRENT_DATE+180,'2026-06-20',true,false,2.50,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-047-A','SKU-047',200,CURRENT_DATE+120,'2026-05-10',true,false,0.85,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-048-A','SKU-048',180,CURRENT_DATE+130,'2026-05-20',true,false,0.95,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-049-A','SKU-049',150,CURRENT_DATE+110,'2026-04-30',true,false,0.90,'e1000000-0000-0000-0000-000000000005',NOW()),
('LOT-050-A','SKU-050',220,CURRENT_DATE+140,'2026-05-25',true,false,0.70,'e1000000-0000-0000-0000-000000000005',NOW())
...
-- ══════════════════════════════════════════════════════════════
-- 8. PEDIDOS, PRODUCTOS_PEDIDO Y LOTES_COMPROMETIDOS
-- ══════════════════════════════════════════════════════
